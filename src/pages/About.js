...
import imgphone from "../images/istockphoto-1342346380-612x612.jpg";

const faqs = [
  {
    question: "Can I rent a car without a credit card?",
    answer: "Yes, but this depends on the rental company's policy...",
  },
  {
    question: "What are the requirements for renting a car?",
    answer: "You typically need a valid driver’s license and to meet age requirements.",
  },
  {
    question: "Does Car Rental allow me to tow with or attach a hitch?",
    answer: "Most rental companies do not allow towing, but check with the provider.",
  },
  {
    question: "Does Car Rental offer coverage products with my rental?",
    answer: "Yes, various protection packages are usually available at extra cost.",
  },
];
      ...
      <section id="about" className="containeer">
        ...
        <div className="flex justify-center items-center mt-10">
          <video className="rounded-2xl w-10/12" controls>
            <source
              src={require('../images/106722-673786473_tiny.mp4')}
              type="video/mp4"
            />
        ...
        <div className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="w-full h-80 rounded-lg overflow-hidden">
              <img src={memoryImg} alt="Memory Image" className="w-full h-full object-cover "/>
            </div>
          </div>
        </div>

  
<div className="bg-[#5937E0] rounded-xl p-3 text-white flex flex-col md:flex-row items-center justify-center gap-10 mt-10 mx-4 md:mx-20">
      
      <div className="w-40 md:w-60 mb-6 md:mb-0">
        <img src={imgphone} alt="Phone" className="w-full  " />
      </div>
      <div className="text-center md:text-left max-w-lg">
        <p className="uppercase text-sm opacity-80 mb-1">Download our app</p>
        ...
        <p className="opacity-80 mb-6">
          ...
          Nisi nisi morbi vel in vulputate. Nulla nam eget urna fusce vulputate et risus.
        </p>
   ...
   <div className="max-w-3xl mx-auto p-6">
      <h2 className="text-3xl font-bold mb-6 text-center">Top Car Rental Questions</h2>
      {faqs.map((faq, index) => (
        <div
          key={index}
          className="border rounded-lg mb-4 p-4 cursor-pointer hover:bg-gray-50 transition"
        ...
        <div className="w-full max-w-6xl mx-auto px-4 py-12 section mb-14">
          <h2 className="text-3xl font-bold text-center  mb-5">Reviews from our customers</h2>
          <div className="flex flex-col md:flex-row gap-6 justify-center ">
            <div className=" bg-gray-200 rounded-2xl shadow-md flex-1 flex flex-col items-center pb-0 ">
              <div className="w-full flex flex-col items-center px-6 pt-8 pb-4">
                <img className="w-8 h-8 text-purple-500 mb-4" src={reviewIcon} alt=""/>
              ...
              <div className="w-full bg-purple-600 rounded-b-xl flex flex-col items-center pt-10 pb-4 relative">
                <img src={avatarImg} alt="avatar" className="w-16 h-16 rounded-full absolute -top-8 shadow-md object-cover"/>
            ...
            <div className="bg-gray-200 rounded-xl shadow-md flex-1 flex flex-col items-center pb-0 ">
              ...
              <div className="w-full bg-purple-600 rounded-b-xl flex flex-col items-center pt-10 pb-4 relative">
                <img src={avatarImg} alt="avatar" className="w-16 h-16 rounded-full absolute -top-8 shadow-md object-cover"/>
                <span className="text-purple-200 text-xs m-8">Kuphal LLC</span>
